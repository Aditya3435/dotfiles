...
local function RunCode()
	...
	-- =========================
	if ext == "cpp" then
		local compile_cmd = "g++ -std=c++17 -Wall -Wextra -O2 '" .. fileName .. "' -o '" .. fileBase .. "'"
...
require("flash").setup({
	...
	-- Or customize things like labels and jump behavior
...
require("image").setup({
	backend = "kitty", -- or "ueberzug" if you have it installed
	integrations = {
		markdown = {
			enabled = true,
			...
			filetypes = { "markdown", "vimwiki", "quarto" }, -- Add quarto if you use it
		},
	},
	max_width = 100,
	max_height = 12,
...
vim.g.molten_auto_open_output = false -- I prefer manual toggle
...
local function setup_obsidian()
	require("obsidian").setup({
		...
		workspaces = { { name = "Home", path = "~/Notes" } },
		picker = { name = "fzf-lua" },
	})
